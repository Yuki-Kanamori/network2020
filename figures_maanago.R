require(ggvast)
require(rgdal)
setwd("/Users/Yuki/Dropbox/Network2020/maanago_lognorm0")

# 0.1 set the directory ---------------------------------------------
vast_output_dirname = "/Users/Yuki/Dropbox/Network2020/maanago_lognorm0"
...
category_name = c("maanago") #カテゴリーの名前（魚種名や銘柄など）
