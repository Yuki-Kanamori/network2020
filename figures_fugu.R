require(ggvast)
require(rgdal)
setwd("/Users/Yuki/Dropbox/Network2020/torafugu_lognorm3")

# 0.1 set the directory ---------------------------------------------
vast_output_dirname = "/Users/Yuki/Dropbox/Network2020/torafugu_lognorm3"
...
colnames(DG)
na = data_frame(year = 1993, month = NA, lon = NA, lat = NA, cpue = NA, spp = NA, Year = 1993, Month = NA, Lon = NA, Lat = NA, Catch_KG = NA, knot_i = NA, zone = unique(DG$zone), X = NA)
DG = rbind(DG, na)
...
category_name = c("torafugu") #カテゴリーの名前（魚種名や銘柄など）
