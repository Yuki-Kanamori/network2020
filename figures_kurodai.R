require(ggvast)
require(rgdal)
setwd("/Users/Yuki/Dropbox/Network2020/kurodai_lognorm")

# 0.1 set the directory ---------------------------------------------
vast_output_dirname = "/Users/Yuki/Dropbox/Network2020/kurodai_lognorm1990"
...
category_name = c("kurodai") #カテゴリーの名前（魚種名や銘柄など）
